...
class MyTheme {
  static getThemeData({required bool isLight}){
    return ThemeData(
        ...
        // icon theme
        // iconTheme: MyStyles.getIconTheme(isLightTheme: isLight), colorScheme: ColorScheme(background: isLight ? LightThemeColors.backgroundColor : DarkThemeColors.backgroundColor, brightness: , primary: null, onPrimary: null, secondary: null, onSecondary: null),
    );
  }
